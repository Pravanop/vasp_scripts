...
import pandas as pd
path = [[0 , 4 , 14 , 25 , 34 , 39 , 39 , 35 , 28 , 18 , 7 , -3 , -9 , -10 , -4 , 10 , 33 , 68 , 115 , 174],
...
factor = 66
x = np.linspace(-1.33541, 1.33541, 19)
def func(x, a, b ,c ):
...
# for i in range(len(doping)):
#     ax[0].plot(x , func(x*factor , *popt_list[i]) , linewidth = linewidth , alpha = alpha , c = colors[i])
